...
import { ArrowRight, Banknote, Calendar, Download, MapPin } from "lucide-react";
          ...
          <article className="mt-4 w-full flex flex-col gap-6">
            <div className="flex flex-col gap-1">
              ...
              <p className="text-justify text-gray-600 font-regular">
                ...
                dolorem possimus iure ipsa voluptatibus ipsum eius blanditiis
                excepturi dignissimos beatae modi, perspiciatis ex quis. Itaque
                ipsum totam aliquam excepturi incidunt. Lorem, ipsum dolor sit
                amet consectetur adipisicing elit. Ipsum adipisci alias non illo
                animi libero. Id amet neque magnam odio, velit vero nemo animi
                quidem temporibus exercitationem sapiente, ipsam quis.
              </p>
            </div>
